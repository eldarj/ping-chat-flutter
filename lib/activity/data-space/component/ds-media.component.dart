...
class DSMedia extends StatefulWidget {
  ...
  const DSMedia({Key key,
    this.node, this.picturesPath, this.gridHorizontalSize, this.onNodeSelected,
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('MEDIA', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Colors.grey.shade500)),
                            Container(
