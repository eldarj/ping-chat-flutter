...
class _MyRegisterWidget extends State<RegisterWidget>
  ...
  TextEditingController _wsUriController = TextEditingController(text: 'ws://192.168.1.4:5066');
  TextEditingController _sipUriController = TextEditingController(text: '1000@192.168.1.4');
  TextEditingController _displayNameController = TextEditingController(text: '1000');
  TextEditingController _authorizationUserController = TextEditingController(text: '1000');
  Map<String, String> _wsExtraHeaders = {
    'Origin': ' http://192.168.1.4',
    'Host': '192.168.1.4:5066'
  };
  ...
  void _loadSettings() async {
    ...
    this.setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? 'ws://192.168.1.4:5066';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? '1000@192.168.1.4';
  ...
  void _handleSave(BuildContext context) {
    ...
    settings.registerParams = new RegisterParams();
    ...
    settings.uri = '1000@192.168.1.4';
    settings.authorizationUser = '1000';
    settings.password = '1234';
    settings.displayName = 'Eldar';
