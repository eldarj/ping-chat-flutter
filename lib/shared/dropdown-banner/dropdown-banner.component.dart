...
class _BannerInstance extends StatefulWidget {
  ...
  // Icon to display as leading widget in the banner
  final Widget icon;
  ...
  _BannerInstance(this.id, this.duration, this.text, this.icon, this.actions, this.color, this.textStyle,
            ...
            child: SafeArea(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(
                    child: Container(
                      margin: EdgeInsets.only(left: widget.icon != null ? 15 : 0, right: widget.actions != null ? 15 : 0),
                      child: Text(
                        widget.text,
                        style: TextStyle(
                            color: Colors.black,
                  ...
                  widget.actions != null ? Row(children: [
                    ...widget.actions
                  ]) : Container()
                ],
              ),
